...
static BYTE  *pbData;   /**< pointer to data buffer */
...
static BYTE *apbDataStore [4] = { NULL, NULL, NULL, NULL };                   // Array of installed request data pointers */
...
//
static BOOL _HandleRequest (TSetupPacket *pSetup, int *piLen, BYTE **ppbData)
{
...
//
static void usbStallControlPipe (BYTE bEPStat __attribute__ ((unused)))
{
...
int usbHandleControlTransfer (BYTE bEP, BYTE bEPStat)
{
  ...
  if (bEP == 0x00) 
  {
    if (bEPStat & EP_STATUS_SETUP) 
    {
      ...
      //
      usbHardwareEndpointRead (0x00, (BYTE *) &Setup, sizeof (Setup));
