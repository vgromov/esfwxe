...
static __inline esBL vsp25xxIsValidType(esU8 type)
{
...
static void vsp25xxBusPutBits(vsp25xxBusHANDLE h, esU16 data, esU8 bits)
{
	if(	h->rloadSet &&
		h->sclkSet &&
		h->dataSet )
...
static esBL vsp25xxBusPutBytes(vsp25xxBusHANDLE h, esU16 addr, esU16 data, esU8 dataBits)
{
	if( h &&
		vsp25xxIsValidType(h->type) &&
		h->sloadSet )
	{
		esU8 rloadMode = (h->clockPolarityCtl & vsp25xxCPCtlRLOADmask);
...
//
void vsp25xxClockPolarityCtlSet(vsp25xxBusHANDLE h, esU8 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
esU8 vsp25xxClockPolarityCtlGet(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) )
...
// standby settings
//
void vsp25xxStandbySettingSet(vsp25xxBusHANDLE h, esU8 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
esU8 vsp25xxStandbySettingGet(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) )
...
//
void vsp25xxDataOutputSettingSet(vsp25xxBusHANDLE h, esU8 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
esU8 vsp25xxDataOutputSettingGet(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) )
...
//
void vsp25xxShdSamplingDelaySet(vsp25xxBusHANDLE h, esU8 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
esU8 vsp25xxShdSamplingDelayGet(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) )
...
// clamping level
//
void vsp25xxClampLevelSet(vsp25xxBusHANDLE h, esU8 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
esU8 vsp25xxClampLevelGet(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) )
		return h->clampLevel;
...
//
void vsp25xxHotRejectionSet(vsp25xxBusHANDLE h, esU8 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
esU8 vsp25xxHotRejectionGet(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) )
...
// DPGA gain settings
//
void vsp25xxDPGAgainSet(vsp25xxBusHANDLE h, esU16 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
esU16 vsp25xxDPGAgainGet(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) )
		return h->dpgaGain;
...
// CDS gain control
//
void vsp25xxCDSgainSet(vsp25xxBusHANDLE h, esU8 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
esU8 vsp25xxCDSgainGet(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) )
...
// power modes control
//
void vsp25xxPowerCtlSet(vsp25xxBusHANDLE h, esU8 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
esU8 vsp25xxPowerCtlGet(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) )
...
// DAC1|2 output write
//
void vsp25xxDACwrite(vsp25xxBusHANDLE h, esU8 dac, esU8 val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
			dac < 2 &&
...
void vsp25xxDACwriteDefault(vsp25xxBusHANDLE h, esU8 dac)
{
	vsp25xxDACwrite(h, dac, 0);
}

esU8 vsp25xxDACget(vsp25xxBusHANDLE h, esU8 dac)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
			dac < 2 )
...
//
void vsp25xxCcdRefLevelClkSet(vsp25xxBusHANDLE h, esBL val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
			h->ccdRefLevelClkSet )
...
void vsp25xxCcdDataLevelClkSet(vsp25xxBusHANDLE h, esBL val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
void vsp25xxCcdADCclkSet(vsp25xxBusHANDLE h, esBL val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
			h->ccdADCclkSet )
...
void vsp25xxCcdOpticalBlackClkSet(vsp25xxBusHANDLE h, esBL val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
void vsp25xxCcdDummyClampClkSet(vsp25xxBusHANDLE h, esBL val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
...
void vsp25xxCcdBlankClkSet(vsp25xxBusHANDLE h, esBL val)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
			h->ccdBlankClkSet )
...
esU16 vsp25xxCcdDataRead(vsp25xxBusHANDLE h)
{
	if( h &&
			vsp25xxIsValidType(h->type) &&
			h->ccdDataRead )
