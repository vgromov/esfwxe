...
typedef struct {
	...
	esU32 shTickStart;
	esU32 ticksPerPixel;
	esU32 totalPixelTicks;
	esU32 dummyPixelsTickStart;
	esU32 dummyPixelsTickEnd;
	esU32 blackPixelsTickStart;
	esU32 blackPixelsTickEnd;
	esU32 dataPixelTickStart;
	esU32 dataPixelTickEnd;
	esU8 refCaptureStart;
	esU8 refCaptureEnd;
	esU8 dataCaptureStart;
	esU8 dataCaptureEnd;
...
// API
//
static __inline esBL ccdTcdIsValidType(esU8 type)
{
