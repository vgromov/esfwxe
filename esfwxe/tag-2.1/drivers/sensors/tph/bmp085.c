...
esBL bmp085CalibrationGet(i2cHANDLE h, bmp085Calibration* cal)
{
	...
	// read calibration
	if( 1 == i2cPutBytes(h, bmp085Addr, &calReg, 1, false) &&
...
esBL bmp085TemperatureStart(i2cHANDLE h)
{
	...
	return 2 == i2cPutBytes(h, bmp085Addr, tmp, 2, true); // start temperature conversion
}
...
static esBL bmp085ReadUt(i2cHANDLE h, long* ut)
{
	...
	if( 1 == i2cPutBytes(h, bmp085Addr, tmp, 1, false) &&
...
esBL bmp05PressureStart(i2cHANDLE h, esU8 precision)
{
	...
	return 2 == i2cPutBytes(h, bmp085Addr, tmp, 2, true);
}
