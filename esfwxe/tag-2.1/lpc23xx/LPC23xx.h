...
/* FIOs can be accessed through esU16, HALF-esU16 or esU8. */
...
#define PCPWM1          0x00000040  // PCPWM1 PWM1 power/clock control bit. 1
#define PCI2C0          0x00000080  // PCI2C0 The I2C0 interface power/clock control bit. 1
#define PCSPI            0x00000100  // PCSPI The SPI interface power/clock control bit. 1
#define PCRTC            0x00000200  // PCRTC The RTC power/clock control bit. 1
#define PCSSP1          0x00000400   // PCSSP1 The SSP 1 interface power/clock control bit. 1
#define PCEMC            0x00000800  // PCEMC External Memory Controller 1
#define PCAD            0x00001000  // PCAD A/D converter (ADC) power/clock control bit.
                                    // Note: Clear the PDN bit in the AD0CR before clearing this bit, and set
                                    // this bit before setting PDN.
#define PCCAN1          0x00002000  // PCCAN1 CAN Controller 1 power/clock control bit. 0
#define PCCAN2          0x00004000  // PCCAN2 CAN Controller 2 power/clock control bit. 0
...
#define PCLCD           0x00100000  // PCLCD LCD controller power control bit. 0 (for lpc2478 only)
#define PCSSP0          0x00200000  // PCSSP0 The SSP0 interface power/clock control bit. 1
#define PCTIM2          0x00400000  // PCTIM2 Timer 2 power/clock control bit. 0
#define PCTIM3          0x00800000  // PCTIM3 Timer 3 power/clock control bit. 0
#define PCUART2          0x01000000  // PCUART2 UART 2 power/clock control bit. 0
#define PCUART3         0x02000000  // PCUART3 UART 3 power/clock control bit. 0
#define PCI2C2          0x04000000  // PCI2C2 I2S interface 2 power/clock control bit. 1
#define PCI2S            0x08000000  // PCI2S I2S interface power/clock control bit. 0
#define PCSDC            0x10000000  // PCSDC SD card interface power/clock control bit. 0
#define PCGPDMA          0x20000000  // PCGPDMA GP DMA function power/clock control bit. 0
#define PCENET          0x40000000  // PCENET Ethernet block power/clock control bit. 0
