...
extern esBL HID_GetReport   (void);
extern esBL HID_SetReport   (void);
extern esBL HID_GetIdle     (void);
extern esBL HID_SetIdle     (void);
extern esBL HID_GetProtocol (void);
extern esBL HID_SetProtocol (void);
