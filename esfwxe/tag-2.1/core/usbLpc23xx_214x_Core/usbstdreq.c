...
//
esBL usbGetDescriptor (esU16 wTypeIndex, esU16 wLangID __attribute__ ((unused)), int *piLen, esU8 **ppbData)
{
  esU8  bType, bIndex;
  esU8  *pab;
  int iCurIndex;
...
//
static esBL usbSetConfiguration (esU8 bConfigIndex, esU8 bAltSetting)
{
  esU8  *pab;
  esU8  bCurConfig, bCurAltSetting;
  esU8  bEP;
  esU16 wMaxPktSize;
...
//
static esBL usbHandleStdDeviceReq (TSetupPacket *pSetup, int *piLen, esU8 **ppbData)
{
  esU8  *pbData = *ppbData;
...
//
static esBL usbHandleStdInterfaceReq (TSetupPacket  *pSetup, int *piLen, esU8 **ppbData)
{
  esU8  *pbData = *ppbData;
...
// 
static esBL usbHandleStdEndPointReq (TSetupPacket *pSetup, int *piLen, esU8 **ppbData)
{
  esU8  *pbData = *ppbData;
