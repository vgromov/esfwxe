// lpc13xx uart driver implementation
// this file is implicitly included from ../uart.c
...
// UART baud rate configuration algorithm implementation taken from lpc13xx datasheet
