...
//      MSC_SetStallEP(MSC_EP_IN);            // __TEST; after EP UNSTALL alwys 0-length packet is transmitted
      MSC_SetCSW();                           //         and not the data written to it.
      break;
    case MSC_BS_CSW:
      BulkStage = MSC_BS_CBW;
      break;
