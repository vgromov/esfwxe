...
__inline esBL USB_ReqGetStatus (void) {
  U32 n, m;
...
__inline esBL USB_ReqSetClrFeature (U32 sc) {
  U32 n, m;
...
__inline esBL USB_ReqSetAddress (void) {
...
__inline esBL USB_ReqGetDescriptor (void) {
  U8  *pD;
  U32 len, n;
...
__inline esBL USB_ReqGetConfiguration (void) {
...
__inline esBL USB_ReqSetConfiguration (void) {
...
__inline esBL USB_ReqGetInterface (void) {
...
__inline esBL USB_ReqSetInterface (void) {
  USB_COMMON_DESCRIPTOR *pD;
