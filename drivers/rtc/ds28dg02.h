...
//
// RTC initialization
void ds28dg02InitRTC(spiHANDLE bus, esU8 ctl);
...
esBL ds28dg02SetPIODirection( spiHANDLE bus, esU16 dir );
esBL ds28dg02GetPIODirection( spiHANDLE bus, esU16* dir );
esBL ds28dg02SetPIOState( spiHANDLE bus, esU16 state );
esBL ds28dg02GetPIOState( spiHANDLE bus, esU16* state );
esBL ds28dg02GetPIOInput( spiHANDLE bus, esU16* input );
