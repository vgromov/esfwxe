...
// THIS IS BY DESIGN!!! Instance is declared in EseBleBg. void (*bglib_output)(uint8 len1,uint8* data1,uint16 len2,uint8* data2)=0;
...
// THIS IS BY DESIGN!        if(bglib_output)
