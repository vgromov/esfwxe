...
static esU8  *pbData;   /**< pointer to data buffer */
...
static esU8 *apbDataStore [4] = { NULL, NULL, NULL, NULL };                   // Array of installed request data pointers */
...
//
static esBL _HandleRequest (TSetupPacket *pSetup, int *piLen, esU8 **ppbData)
{
...
//
static void usbStallControlPipe (esU8 bEPStat __attribute__ ((unused)))
{
...
int usbHandleControlTransfer (esU8 bEP, esU8 bEPStat)
{
  ...
  if (bEP == 0x00) 
  {
    if (bEPStat & EP_STATUS_SETUP) 
    {
      ...
      //
      usbHardwareEndpointRead (0x00, (esU8 *) &Setup, sizeof (Setup));
