...
#define I2C_INIT_SLAVE(portNum, dcb) \
    ...
    {  \
      ...
      ports[i2c## portNum].txRxQueue = xQueueCreate( I2C_IO_BUFFLEN, sizeof(esU8) ); \
...
#define I2C_INIT_SLAVE(portNum, dcb) \
    ...
    {  \
      ports[i2c## portNum].dcb = *dcb; \
      rbInit((rbHANDLE)&ports[i2c## portNum].txRxQueue, (esU8*)ports[i2c## portNum].txRxData, I2C_IO_BUFFLEN); \
       return ((i2cHANDLE)&ports[i2c## portNum]); \
    }
