...
public:
  ...
  virtual int currentLangIdGet() const ESE_NOTHROW = 0;
  virtual void currentLangIdSet(int langId) ESE_NOTHROW = 0;
  
  virtual int langIdGetByCode(const char* code) const ESE_NOTHROW = 0;
  virtual const char* langCodeGet(int langId) const ESE_NOTHROW = 0;
